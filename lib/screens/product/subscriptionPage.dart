...
class _SubscriptionPageState extends State<SubscriptionPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: appBarPrimary(context, "SUBSCRIPTION"),
      body: ListView(
        children: <Widget>[
          SizedBox(height: 20),
          Container(
            ...
            child: Column(
              ...
              children: [
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return InkWell(
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                              color:
                                  isSelected ? Color(0xFFCF2D4D) : Colors.white,
                              border: isSelected
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    regularTextatStart(context, "SERVICE_CHARGES"),
                    regularTextatStart(context, "\$1"),
                  ],
                ),
                SizedBox(height: 10),
              ],
          ...
          GFAccordion(
            ...
            titleChild: Row(
              children: [
                Image.asset("lib/assets/icons/map.png", width: 16, height: 23),
                SizedBox(width: 5),
                Text(
                                ...
                                children: <Widget>[
                                  ...
                                  InkWell(
                                    ...
                                    padding: const EdgeInsets.symmetric(
                                        horizontal: 20.0),
                                    child:
                                        primaryOutlineButton(context, "DELETE"),
                                  )),
                                ],
                              ),
                            ),
