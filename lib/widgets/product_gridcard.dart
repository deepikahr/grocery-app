                            ...
                            children: <Widget>[
                              ...
                              Row(
                                ...
                                children: <Widget>[
                                  priceMrpText(
                                      dealPercentage == null
                                          ? '${widget.currency}${(variantPrice == null ? widget.productData['variant'][0]['price'] : variantPrice).toDouble().toStringAsFixed(2)}'
                                          : '${widget.currency}${((variantPrice == null ? widget.productData['variant'][0]['price'] : variantPrice) - ((variantPrice == null ? widget.productData['variant'][0]['price'] : variantPrice) * (dealPercentage / 100))).toDouble().toStringAsFixed(2)}',
                                      dealPercentage != null
                                          ? '${widget.currency}${(variantPrice == null ? widget.productData['variant'][0]['price'] : variantPrice).toDouble().toStringAsFixed(2)}'
                                          : null,
                                      context),
                                                            ...
                                                            for (int i = 0;
                                                              ...
                                                              if (widget.productData[
                                                                ...
                                                                if (mounted) {
                                                                  setState(() {
                                                                    widget.productData[
                                                                        'quantityToCart'] = onValue['response_data']
                                                                            [
                                                                            'products'][i]
                                                                        [
                                                                        'quantity'];
                                                                    ...
                                                                    variantPrice =
                                                                        onValue['response_data']['products'][i]
                                                                            [
                                                                            'price'];
                                                                    variantUnit =
                                                                        onValue['response_data']['products'][i]
